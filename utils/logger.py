...
class Logger():
    ...
    def save_images(self, iteration, color_image, depth_image, mode):
        ...
        depth_image = np.round(depth_image * 10000).astype(np.uint16) # Save depth in 1e-4 meters * 10000
    ...
    def save_heightmaps(self, iteration, color_heightmap, depth_heightmap, mode):
        ...
        depth_heightmap = np.round(depth_heightmap).astype(np.uint16) # Save depth in 1e-5 meters * 100000
